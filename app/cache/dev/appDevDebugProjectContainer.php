...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'accountservice' => 'getAccountserviceService',
            ...
            'form_login' => 'getFormLoginService',
            'form_new_password' => 'getFormNewPasswordService',
            'form_reset_password' => 'getFormResetPasswordService',
            'formdbservice' => 'getFormdbserviceService',
    ...
    /**
     * Gets the 'accountservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Service\AccountService A Acme\DemoBundle\Service\AccountService instance.
     */
    protected function getAccountserviceService()
    {
        return $this->services['accountservice'] = new \Acme\DemoBundle\Service\AccountService($this->get('doctrine', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('factory', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this, $this->get('util', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('security.encoder_factory', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8683b15412f0fe3e99718ebabdd56829b075b4f7bca75f3b726e5a8f736407a0');
    ...
    /**
     * Gets the 'emailer' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Service\EmailService A Acme\DemoBundle\Service\EmailService instance.
     */
    protected function getEmailerService()
    {
        return $this->services['emailer'] = new \Acme\DemoBundle\Service\EmailService($this->get('factory', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('util', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('router', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('swiftmailer.mailer.default', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('templating', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this);
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Service\FactoryService A Acme\DemoBundle\Service\FactoryService instance.
     */
    protected function getFactoryService()
    {
        return $this->services['factory'] = new \Acme\DemoBundle\Service\FactoryService();
    }
    ...
    /**
     * Gets the 'form_login' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Form\LoginForm A Acme\DemoBundle\Form\LoginForm instance.
     */
    protected function getFormLoginService()
    {
        return $this->services['form_login'] = new \Acme\DemoBundle\Form\LoginForm($this->get('validator'));
    }

    /**
     * Gets the 'form_new_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Form\NewPasswordForm A Acme\DemoBundle\Form\NewPasswordForm instance.
     */
    protected function getFormNewPasswordService()
    {
        return $this->services['form_new_password'] = new \Acme\DemoBundle\Form\NewPasswordForm($this->get('validator'), $this->get('factory'), $this->get('formdbservice'));
    }

    /**
     * Gets the 'form_reset_password' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Form\ResetPasswordForm A Acme\DemoBundle\Form\ResetPasswordForm instance.
     */
    protected function getFormResetPasswordService()
    {
        return $this->services['form_reset_password'] = new \Acme\DemoBundle\Form\ResetPasswordForm($this->get('validator'));
    }

    /**
     * Gets the 'formdbservice' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Service\FormDbService A Acme\DemoBundle\Service\FormDbService instance.
     */
    protected function getFormdbserviceService()
    {
        return $this->services['formdbservice'] = new \Acme\DemoBundle\Service\FormDbService($this->get('doctrine', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('factory', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Acme\\DemoBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'md5', 1 => false, 2 => 1))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_SecuredAreaService()
    {
        ...
        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/club');

        $j = new \Symfony\Component\HttpFoundation\RequestMatcher('^/invite/to/puntclub');

        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/existinguser/signup');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/switch');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/account');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/invitations');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/notification');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/email/json/upload');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/email/preview');
        ...
        $t = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), 'puntclub_12645465', 'secured_area', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);

        $u = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $s, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($s, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        ...
        $v->setOptions(array('login_path' => '/login', 'default_target_path' => '/dashboard', 'always_use_default_target_path' => false, 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $v->setProviderKey('secured_area');

        $w = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($f, $s, array(), $a);
        $w->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        $x = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, new \Symfony\Component\Security\Http\Session\SessionAuthenticationStrategy('migrate'), $s, 'secured_area', $v, $w, array('check_path' => '/login/check', 'username_parameter' => 'email', 'password_parameter' => 'password', 'use_forward' => false, 'require_previous_session' => true, 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $x->setRememberMeServices($t);

        return $this->services['security.firewall.map.context.secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($r, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'secured_area', $a, $d), 2 => $u, 3 => $x, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $t, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5531dbc8a5614', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $r, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $s, 'secured_area', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $s, '/login', false), NULL, NULL, $a));
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('0dcab7cf57556278d3ec0a9bce794b9d34d0f23c');
    }

    /**
     * Gets the 'util' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Acme\DemoBundle\Utility\Util A Acme\DemoBundle\Utility\Util instance.
     */
    protected function getUtilService()
    {
        $this->services['util'] = $instance = new \Acme\DemoBundle\Utility\Util();
    ...
    {
        return $this->services['security.user.provider.concrete.main'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'AcmeDemoBundle:User', 'email', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'locale' => 'en',
            'secret' => '0dcab7cf57556278d3ec0a9bce794b9d34d0f23c',
            'database_path' => NULL,
            ...
            'kernel.secret' => '0dcab7cf57556278d3ec0a9bce794b9d34d0f23c',
